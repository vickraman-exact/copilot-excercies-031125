    ...
    <div className="flex min-h-screen flex-col justify-center bg-gray-100 py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img
          ...
          alt="HRPay-Dezk Logo"
        />
        <h1 className="mt-6 text-center text-3xl font-extrabold text-gray-900">HRPay-Dezk</h1>
        <h2 className="mt-2 text-center text-md text-gray-600">HR & Payroll Management System</h2>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              <div className="rounded-md bg-gray-50 px-3 py-2 text-center text-sm text-gray-800">
